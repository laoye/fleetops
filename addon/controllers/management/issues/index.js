    ...
    get columns() {
        return [
            ...
            },
            {
                ...
                placeholder: this.intl.t('common.select-issue-type'),
            },
            {
                ...
                placeholder: this.intl.t('common.select-issue-category'),
            },
            {
                ...
                filterComponentPlaceholder: this.intl.t('common.select-resource', { resource: this.intl.t('resource.reporter') }),
            ...
            },
            {
                ...
                filterable: true,
                filterComponent: 'filter/model',
                filterComponentPlaceholder: this.intl.t('common.select-resource', { resource: this.intl.t('resource.assignee') }),
            ...
            },
            {
                ...
                filterable: true,
                filterComponent: 'filter/model',
                filterComponentPlaceholder: this.intl.t('common.select-resource', { resource: this.intl.t('resource.driver') }),
                filterParam: 'driver',
                model: 'driver',
            },
            {
                ...
                filterable: true,
                filterComponent: 'filter/model',
                filterComponentPlaceholder: this.intl.t('common.select-resource', { resource: this.intl.t('resource.vehicle') }),
                filterParam: 'vehicle',
                model: 'vehicle',
