    ...
    get columns() {
        return [
            ...
            },
            {
                ...
                filterable: true,
                filterComponent: 'filter/model',
                filterComponentPlaceholder: this.intl.t('common.select-resource-filter-by', { resource: this.intl.t('resource.vehicle') }),
                filterParam: 'vehicle',
                model: 'vehicle',
            },
            {
                ...
                filterable: true,
                filterComponent: 'filter/model',
                filterComponentPlaceholder: this.intl.t('common.select-resource-filter-by', { resource: this.intl.t('resource.fleet') }),
                filterParam: 'fleet',
                model: 'fleet',
            },
            {
